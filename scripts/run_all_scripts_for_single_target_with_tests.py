...
def requestPlatformFromUser() -> None:
    ...
    if platform_chosen == "Windows":
        if build_system_chosen == "CMake":
            ...
            run([executable, str(current_script_folder_path / "cmake" / "windows" / "run_tests_for_single_target.py")])
        ...
        if build_system_chosen == "CMake":
            ...
            run([executable, str(current_script_folder_path / "cmake" / "linux" / "run_tests_for_single_target.py")])
